package com.adjecti.user.displaycontext;
...
public class UserManagementToolbarDisplayContext extends BaseManagementToolbarDisplayContext {

	public UserManagementToolbarDisplayContext(LiferayPortletRequest liferayPortletRequest,
		...
		return new CreationMenu() {
			{
				...
				addDropdownItem(dropdownItem -> {
					dropdownItem.setHref(liferayPortletResponse.createRenderURL(), "mvcRenderCommandName",
							MVCCommandNames.ADD_USER_FORM, "redirect", currentURLObj.toString());
	...
	// clearing searching result
		...
		public String getDisplayStyle() {
			...
			if (Validator.isNull(displayStyle)) {
				...
				displayStyle = _portalPreferences.getValue(UserPortletKeys.USER, "user-display-style", "descriptive");
			} else {
				_portalPreferences.setValue(UserPortletKeys.USER, "user-display-style", displayStyle);
		...
		protected String getOrderByCol() {
			return ParamUtil.getString(request, "orderByCol", "firstName");
		}
		...
		public String getSearchActionURL() {
			...
			searchURL.setProperty("mvcRenderCommandName",MVCCommandNames.VIEW_USERS);
		...
		public List<ViewTypeItem> getViewTypeItems() {
			...
			portletURL.setProperty("mvcRenderCommandName", MVCCommandNames.VIEW_USERS);
		...
		protected List<DropdownItem> getOrderByDropdownItems() {
			return new DropdownItemList() {
				{
				/*
				 * add(dropdownItem -> { dropdownItem.setActive("age".equals(getOrderByCol()));
		...
		private PortletURL getCurrentSortingURL() throws PortletException {
			...
			sortingURL.setParameter("mvcRenderCommandName", MVCCommandNames.VIEW_USERS);
