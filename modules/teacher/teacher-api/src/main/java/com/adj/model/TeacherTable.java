...
/**
 * The table class for the &quot;SC_Teacher&quot; database table.
 *
...
public class TeacherTable extends BaseTable<TeacherTable> {
	...
	public final Column<TeacherTable, Long> groupId = createColumn(
		"groupId", Long.class, Types.BIGINT, Column.FLAG_DEFAULT);
	public final Column<TeacherTable, Long> companyId = createColumn(
		"companyId", Long.class, Types.BIGINT, Column.FLAG_DEFAULT);
	public final Column<TeacherTable, Long> userId = createColumn(
		"userId", Long.class, Types.BIGINT, Column.FLAG_DEFAULT);
	public final Column<TeacherTable, String> userName = createColumn(
		"userName", String.class, Types.VARCHAR, Column.FLAG_DEFAULT);
	public final Column<TeacherTable, Date> createDate = createColumn(
		"createDate", Date.class, Types.TIMESTAMP, Column.FLAG_DEFAULT);
	public final Column<TeacherTable, Date> modifiedDate = createColumn(
		"modifiedDate", Date.class, Types.TIMESTAMP, Column.FLAG_DEFAULT);
	public final Column<TeacherTable, String> name = createColumn(
		"name", String.class, Types.VARCHAR, Column.FLAG_DEFAULT);
	public final Column<TeacherTable, String> department = createColumn(
		"department", String.class, Types.VARCHAR, Column.FLAG_DEFAULT);
	public final Column<TeacherTable, Integer> age = createColumn(
		"age", Integer.class, Types.INTEGER, Column.FLAG_DEFAULT);
	public final Column<TeacherTable, Long> salary = createColumn(
	...
	private TeacherTable() {
		super("SC_Teacher", TeacherTable::new);
	}
